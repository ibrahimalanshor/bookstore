<form class="card" wire:submit.prevent="add">
	...
	<div class="card-body">
		...
		<div class="form-group" wire:ignore>
			...
			<select class="form-control custom-select supplier" wire:model="supplier_id" required></select>
		</div>
	...
	<div class="card-footer">
		<button class="btn btn-primary" type="submit" wire:loading.attr="disabled" wire:target="add">Add</button>
	</div>
</form>
